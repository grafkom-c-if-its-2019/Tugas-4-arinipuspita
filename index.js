...
(function(global) {
  ...
  function main() {
    ...
    function cube(){
      ...
      var cubeVertices = [
        // x, y, z            u, v         normal
              ...
              // -0.5,  0.5,  0.5,     1.0, 1.0, 0.0,  // depan kuning
              ...
              //  0.5, -0.5,  0.5,     1.0, 1.0, 0.0,
               ...
               0.5,  0.5,  0.5,     1.0, 0.0, 0.0,  // kanan merah
               ...
               0.5, -0.5,  0.5,     1.0, 0.0, 1.0,  // bawah magenta
              ...
              -0.5, -0.5, -0.5,     0.0, 1.0, 0.0,  // belakang hijau
              ...
              -0.5,  0.5, -0.5,     0.0, 0.0, 1.0,  // kiri cyan
              ...
              -0.5, -0.5,  0.5,     0.0, 0.0, 1.0,
               ...
               0.5,  0.5, -0.5,     0.0, 1.0, 1.0,  // atas cyan
      ...
      var ambientColor = glMatrix.vec3.fromValues(0.17, 0.00, 0.40);
    ...
    function triangle(){
      ...
      var ambientColor = glMatrix.vec3.fromValues(0.17, 0.0, 0.40);
    ...
    function texturePack(){      
      ...
      function initTexture(callback, args) {
        var imageSource = 'images/foto.png';
